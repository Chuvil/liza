...
if(isset($_GET['id'])){
    ...
    $query="SELECT name, theme, text, photo, date FROM posts WHERE id='".$_GET['id']."'";
    ...
    if($_FILES['newPhoto']['error']==0){
        ...
        $query="UPDATE posts SET name='".$_POST['name']."', theme='".$_POST['theme']."', text='".$_POST['text']."', photo='$filename'";
    }else{
        $query="UPDATE posts SET name='".$_POST['name']."', theme='".$_POST['theme']."', text='".$_POST['text']."'";
    }
